...
/* SPI 1 */
#define SPI1_RCM        RCM_APB1_PERIPH_SPI2
#define SPI1_PINS_RCM   RCM_AHB1_PERIPH_GPIOA
...
#define SPI1_PINS       BITS(4,7)

#define SPI1_AF         GPIO_AF_SPI1

#define SPI1_NSS_PIN_SOURCE    GPIO_PIN_SOURCE_4
#define SPI1_SCK_PIN_SOURCE    GPIO_PIN_SOURCE_5
#define SPI1_MISO_PIN_SOURCE   GPIO_PIN_SOURCE_6
#define SPI1_MOSI_PIN_SOURCE   GPIO_PIN_SOURCE_7
